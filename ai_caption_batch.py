...
FALLBACK_PHRASES = [
    ...
    "i can't tell what the object is", 
    "i'm unable to view the image", 
    "please provide the image description",
    "if you describe it", 
    "i'm a language model", 
    "i don't have access to the image", 
    "i need a description of the image", 
    "i can't identify the object", 
    "i cannot interpret images",
    "i am not able to analyze images",
    "i can help if you describe it",
    "i don't have the ability to see images",
    "i am unable to interpret visual content",
    "i'm here to help, but i need a description"
]
...
def is_fallback_caption(caption: str) -> bool:
    ...
    return any(phrase in caption_lower for phrase in FALLBACK_PHRASES)
...
def create_batch_input():
    ...
    for svg_file in os.listdir(IMAGE_FOLDER):
        ...
        try:
            ...
            print(f"Skipping file {svg_file} due to error: {e}")
            failed_files.append(svg_file)
